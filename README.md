...
<div align="center">
  <img src="result.png" width="800" alt="نتایج تشخیص پلاک">
</div>
...
## 📘 معرفی پروژه
این پروژه یک سیستم هوشمند برای تشخیص پلاک خودروهای ایرانی و استخراج نویسه‌های آن (اعداد و حروف) است. با استفاده از معماری پیشرفته YOLO11، این مدل قادر است در شرایط نوری مختلف، پلاک را با دقت بالا شناسایی کند.
